...
namespace _4PsPH.Controllers
{
    public class OccupationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OccupationId,Name,DateTimeCreated,IsPermanent")] Occupation occupation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OccupationId,Name,DateTimeCreated,IsPermanent")] Occupation occupation)
        {
            if (ModelState.IsValid)
            {
